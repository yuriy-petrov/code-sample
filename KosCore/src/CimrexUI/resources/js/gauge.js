...
function Gauge( canvas, options ) {
    ...
    this.drawTicks = function( majorTicks, minorTicks ) {
        ...
        // major ticks
        this.c2d.rotate( this.startDeg );
        this.c2d.lineWidth = this.radius * 0.03;
    ...
    this.drawPointer = function( value ) {
        function pointer( ctx ) {
            ...
            ctx.c2d.lineTo(	0, ctx.radius * 0.01 );
        ...
        this.c2d.beginPath();
        this.c2d.arc( 0, 0, this.radius * 0.04, 0, Math.PI * 2, true );
        this.c2d.fill();
        this.c2d.strokeStyle = that.colors.centerCircleStroke;
        this.c2d.beginPath();
        this.c2d.arc( 0, 0, this.radius * 0.05, 0, Math.PI * 2, true );
        this.c2d.stroke();
    };
...
Gauge.prototype.draw = function() {
    ...
    drawCtx.innerRadius = drawCtx.radius * 0.85;
